...
public static class EditorExtensions
{
    ...
    public static bool IsEnumVal(this SerializedProperty sp, Type enumType, params Enum[] enumVals)
    {
        Assert.IsTrue(enumType.IsEnum);
        Assert.IsTrue(enumVals.All(e => enumType.IsEnumDefined(e)));
        return enumVals.Any(e => sp.enumValueIndex == sp.enumNames.IndexOf(Enum.GetName(enumType, e)));
    }
}