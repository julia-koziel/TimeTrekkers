...
{
    public SnowballParticleSystem ps;
    ...
    void OnTriggerEnter2D(Collider2D other) 
    {
        if (other.gameObject.layer == 8)
        {
            ...
            {
                var otherSnowball = other.GetComponent<SnowballParticle>();
                otherSnowball.shouldHandleCollision = false;
                otherSnowball.moveToRandomPosition();
            }
