...
public class ScissorsBias : MonoBehaviour
{
    ...
    void OutcomeCalculation()
    {
        ...
        if (playerCard == 1 && cpuCard == 3) //player rock cpu paper
        {
        ...
        if (playerCard == 2 && cpuCard == 5) //player paper cpu scissors
        {
            playerLose.GetComponent<Renderer>().enabled = true;
            cpuScoreTotal++;
            StartCoroutine(Wait());
        ...
        if (playerCard == 1 && cpuCard == 5) //player rock and cpu scissors
        {
        ...
        if (playerCard == 2 && cpuCard == 3) //both paper
        {
            playerDraw.GetComponent<Renderer>().enabled = true;
            StartCoroutine(Wait());
        }
        ...
        if (playerCard == 3 && cpuCard == 3) //player scissors and cpu paper
        {
            playerWin.GetComponent<Renderer>().enabled = true;
            playerScoreTotal++;
            StartCoroutine(Wait());
        ...
        if (playerCard == 3 && cpuCard == 5) //both scissors
        {
            playerDraw.GetComponent<Renderer>().enabled = true;
            StartCoroutine(Wait());
        }
