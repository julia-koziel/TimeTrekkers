...
public class PracticeShipBehaviour : MonoBehaviour
{
    public GameObject[] targetships;
    public GameObject[] otherships;
    public PiratePracticelogic gameLogic;
    private int index;
    private float x;
    private int i;
    ...
    void Start()
    {
        ...
        foreach (GameObject ship in targetships)
        {
            ...
            ship.transform.position = new Vector3(-20,0,0);
        }
        ...
        if (position > gameLogic.distance)
        {
            ...
            switch (currentship)
            {
                ...
                .Other:
                    ...
                    otherships[index].GetComponent<Ship2BehaviourPractice>().trial = trial;
                    break;
                ...
                case (int)shipType.Target:
                    ...
                    targetships[index].GetComponent<TargetShipPractice>().trial = trial;
                    break;
                default:
                    break;
            }
